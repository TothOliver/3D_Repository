...
void main(uint3 DTid : SV_DispatchThreadID)
{
    ...
    backBufferUAV[DTid.xy] = ambientBuffer[DTid.xy] * 0.5f + specularBuffer[DTid.xy] * specular;
    cubemapUAV[DTid.xyz] = ambientBuffer[DTid.xy] * 0.5f + specularBuffer[DTid.xy] * specular;
