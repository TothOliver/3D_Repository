...
void CreatePerLightInfo(SpotLightData& light, DirectX::XMFLOAT4 colour = { 0, 0, 0, 0 }, DirectX::XMFLOAT3 direction = {1, 0, 0}, float angle = 0.0f, DirectX::XMFLOAT4 initialPosition = {0, 0, 0, 0}, DirectX::XMFLOAT4 intensity = {0, 0, 0, 0});