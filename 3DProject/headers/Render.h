...
void RenderToTargetUAV(ID3D11Device* device, ID3D11DeviceContext* immediateContext, ID3D11UnorderedAccessView* uav,
	...
	ID3D11SamplerState* sampler, D3D11_VIEWPORT viewport, ID3D11Buffer* vpBuffer, ID3D11Buffer* cameraPosition, CameraD3D11* camera,
	Scene* scene, int uavSlot, ShaderD3D11& vs, ShaderD3D11& cs, ShaderD3D11 ps[2], ShaderD3D11 particleShaders[4], ShaderD3D11& hs, ShaderD3D11& ds);
