...
bool CreateShaders(ID3D11Device* device, ID3D11DeviceContext* context, ShaderD3D11& vShaderShadow, ShaderD3D11& vertexShader, ShaderD3D11& computeShader, ShaderD3D11& pixelShader, InputLayoutD3D11& inputLayout)
{
...
bool ShaderLoader(ID3D11Device* device, ID3D11DeviceContext* context, ShaderD3D11& vShaderShadow, ShaderD3D11& vertexShader, ShaderD3D11& computeShader, ShaderD3D11& pixelShader,
    InputLayoutD3D11& inputLayout, SamplerD3D11& sampler)
{

    CreateShaders(device, context, vShaderShadow, vertexShader, computeShader, pixelShader, inputLayout);
